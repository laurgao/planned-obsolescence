    ...
    return (
        <div style={{ opacity: 0 }}>
            <p id="9c145005-4371-4c64-bf48-0378d46fe99f" className="" style={{ marginTop: 300 }}>
                There is lots of social media attention on recycling. My friends preach recycling to me when we go out to eat, making sure we throw
                out our fast food packaging in the right bin. Schools teach kids to recycle. From Grade 1 to Grade 6, my elementary school worked to
                earn these &quot;gold badges&quot; for meeting a certain quota of waste recycled.
            </p>
            <p id="a8788ca7-3526-44e5-ac02-48ce3a143e37" className="">
                How it should be like, however, is reduce, reuse, recycle, <em>in that order</em>. First reduce, then reuse, and recycle only as a
                last resort when the other two cannot be used. Recycling is not the angel solution that some of my friends like to characterize it
                as. A world recycling 292.4 million tons of waste per year is still, well, producing 292.4 million tons of waste each year.
            </p>
            <p id="9d1ee13b-7844-4d73-a292-f22055e5dd95" className="" onScroll={() => console.log("omg we scrolling")}>
                Furthermore, recycling is horribly inefficient—it uses lots of energy and water. Recycling plants are fragile. Each item that
                arrives at a recycling plant has to be meticulously sorted <em>by human workers, </em>as mixing up plastic with metal damages
                machinery. Recycling gets easily contaminated: if one idiot throws some food into a dumpster of recycling, the whole dumpster can no
                longer be recycled. Each recycled pound of paper uses 5000 gallons of water. Sure, that&#x27;s a huge improvement from the 12 000
                gallons of water it would take to harvest a pound of paper from trees, but 5000 gallons is still a crap ton of water. What if, we
                didn&#x27;t have to use any water at all?
            </p>
            <p id="61aab747-5a99-41fe-b4f2-2c4a715e897e" className="">
                ...
                landfills that are stinkier than your socks. No incinerators pumping even more carbon dioxide in the air. No chemicals leaking out
                of landfills and poisoning our water. No need for &quot;banning plastic&quot; - as we have seen from the War on Drugs, cutting
                supply does not solve the problem when there is a high demand. Banning single use plastic will not solve the problem. Instead,
                change needs to emerge from the bottom up, to eradicate demand for single use plastic. That can be created via a culture of reducing
                waste.
            </p>
            ...
            <p id="966fe6eb-073f-49e6-aaa8-08eaa99e59fe" className="">
                Reducing waste is the solution to the waste problem - not just in plastics, not just in electronic waste, but everywhere. An average
                person in the world produces <strong>4.9 lbs of waste each day</strong>. An average American—even more than that. Does the picture
                of you alone ejecting almost 1 ton of waste into the landfill every year make you cringe?
            </p>
            ...
            <p id="e15b1d8f-b1e9-4d2e-b063-dce20f21ef9f" className="">
                If you didn&#x27;t get that takeout and cooked from home, you&#x27;d reduce the styrofoam packaging and single-use-utensils you
                produce. If you didn&#x27;t get that bubble tea. If you didn&#x27;t buy a new phone while your old one was in perfect condition. The
                list goes on and on.
            </p>
            ...
            <p id="44a3508c-fba4-4f95-bf9c-fa733ae71b90" className="">
                Before purchasing an item, think to yourself, do I really need it? What I like to do is this: if I see something that I want to buy,
                I note it down. 3 days later, do I still want it? Often times, the answer is no. I realized that, by just waiting a few days before
                making a purchase, I&#x27;ve cut down about 90% of items that I would&#x27;ve bought otherwise. It really demonstrates how much
                impulsive purchases we tend to make: see something attractive in the store, 10 mins later you&#x27;re walking out with a receipt.
            </p>
            ...
            <p id="cf3b8c3e-5239-4355-9982-d7c66c7a12ff" className="">
                ...
                &quot;promote economic growth.&quot; Fundamentally, what is economic growth? Economic growth is increasing the amount of goods and
            ...
            <p id="0aed6bb3-6661-405f-a39c-71185f390893" className="">
                An average American replaces a phone <a href="https://www.youtube.com/watch?v=4Z1XYM7bC4k">once every 22.7 months</a>. Multiply that
                by 300 million Americans, that is 150 million new phones being bought ever year. According to the the Environmental Protection
                Agency, Americans throw away
            ...
            <p id="b335ff2e-fe3b-4e29-b299-330a7cb8c025" className="">
                <strong>
                    The reason I care about this problem is that it is so unsatisfying - so much of the e-waste we produce is not necessary! Do
                    Americans need a new phone every 2 years? No way! Last time you bought a new phone, your old one was probably in working
                    condition.
                </strong>
            </p>
            <p id="03e01dc2-312d-485a-8aa8-0152b64fba8a" className="">
                According to a United Nations report, 82.6% of e-waste thrown out in 2019 was not recycled into a designated e-waste collection
                facility. E-waste is poisonous: regular landfills are not built against e-waste poison leaks into rivers. E-waste that burns in
                incinerators release toxins into the air. E-waste makes up 70% of the world&#x27;s toxic waste production.
            </p>
            <p id="9a76c0b8-11e3-4cd6-806e-d71f39d44a2e" className="">
                The 17.4% that does get recycled properly - well, that doesn&#x27;t end up well either. Canada and the States exports 90% of our
                e-waste to developing nations in Asia and Africa, where people scrap it for metals. These are impoverished people who often do this
                in unsafe conditions, lighting up fires on their own property to melt the e-waste. This inadvertently leads to the inhalation toxic
                fumes of cadmium, mercury, and lead, which can cause these people to develop lung and kidney damage.
            </p>
            ...
            <p id="fb920fb3-677f-48d8-9b7c-7f3db17a37a1" className="">
                Footnote: It&#x27;s not just capitalism and planned obsolescence. It&#x27;s also consumerist culture. 3 years ago, if you had an
                iPhone 7, you would be the *kool kid* in my in my className. Today, if you have an iPhone 7, you would be ostracized as a boomer.
            </p>
