            ...
            <Container className="py-24">
                <div className="prose mx-auto">
                    ...
                    <p>
                        ...
                        &quot;promote economic growth.&quot; Fundamentally, what is economic growth? Economic growth is increasing the amount of
                    ...
                    <p>
                        The problem of e-waste is not just capitalism and planned obsolescence. It&#x27;s also consumerist culture. 3 years ago, if
                        you had an iPhone 7, you would be the <em>cool kid</em> in my class. Today, if you have an iPhone 7, you would be ostracized
                        as a boomer.
                    </p>
                    <h2 id="solution">A problem created by capitalism requires a solution through capitalism</h2>
                    <p>
                        The root cause of electronic waste, the production of <em>70% of the world&#x27;s toxic waste</em> is largely caused by
                        human behaviour, culture, and first world problems. This is what makes this problem interesting to me. It requires a
                        <em>different type of innovation</em>. A better, more durable phone may be a solution to planned-obscolescence, but against
                        the backdrop of a culture that rewards continuous purchasing of new and improved products, it is useless.
                    </p>
                    <p>
                        Instead, in order to create a company to solve this problem, a a Tesla-esque innovation is required—one that doesn&#x27;t
                        just shake the industry, but shapes the social constructs around electric cars.
                    </p>
                </div>
                <div className="my-14 p-10 rounded-2xl prose prose-invert mx-auto bg-blue-900">
                    ...
                    <p>
                        It's worth emphasizing how uncool they were. The 1970s Arab oil crisis was the one time that interest in electric cars had
                        any resurgence since their loss against gasoline cars to take over the market more than a century ago. One of the only EVs
                        that made decent traction in the US at this time was the Citicar, which sold a{" "}
                    ...
                    <p>
                        ...
                        <a href="https://en.wikipedia.org/wiki/Tesla_Roadster_(first_generation)">travelling 393 km on a single charge</a>. It had
                        the 0 to 60 mph (0 to 97 km/h) acceleration of 3.7 seconds, which was comparable to some of the best gasoline cars. This was
                        the first time people realized that electric cars could be good.
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        leading to a cascade of side effects such as big gas car companies like Ford investing into their own development of
                        electric cars and GM committing to "bringing the world to an all-electric future."
                    </p>
                </div>
                <div className="prose mx-auto">
                    <p>
                        ...
                        transport - changing the perception around what type of phone is sexy. Changing the norm from &quot;the latest and greatest
                        is cool&quot; to, &quot;I can repair my own electronics. I owned this phone for 10 years. That is cool.&quot;
                    </p>
                    <p>
                        There has been progress made in this front, such as a recent startup Framework which makes completely repairable, upgradabe,
